          ...
          <div>
            ...
            <div class="Contents">
                <div id="Contents1">
                    ...
                    <div id="Delete-Item">
                        <h2 id="H">Delete Restaurant</h2><br>
                        <form method="post" action='../Controllers/Admin_Check_Rest_Delete.php'>
                            ...
                            <?php
                            //Pop Up Code--------------------------------------------------------------
                            if(!empty($_SESSION['R_Delete1']))
                                { 
                            ?>
                                <script>swal("Success!", "Restaurant Deleted.", "success");</script>
                            <?php unset($_SESSION['R_Delete1']) ?>
                
                            <?php
                            }
                            else if(!empty($_SESSION['R_Delete2']))
                            { 
                            ?>
                            <script>swal("Failed", "Please, fill the box Correctly.", "error");</script>
                            <?php unset($_SESSION['R_Delete2']) ?>
                            <?php
                            }
                            ?>
                        </form> 
