...
<html>
    ...
    <div class="datetime">
        ...
        <div class="Contents">
                ...
                <div id="Contents3">
                    <div id="Delete-Item">
                        <h2 id="H">Delete Service Provider</h2><br>
                        <form method="post" action='../Controllers/Admin_Check_Srvc_Provider_Delete.php'>
                            ...
                            <?php
                            //Pop Up Code--------------------------------------------------------------
                            if(!empty($_SESSION['Sp_Delete1']))
                                { 
                            ?>
                                <script>swal("Success!", "Employee Deleted.", "success");</script>
                            <?php unset($_SESSION['Sp_Delete1']) ?>
                
                            <?php
                            }
                            else if(!empty($_SESSION['Sp_Delete2']))
                            { 
                            ?>
                            <script>swal("Failed", "Please, fill the box Correctly.", "error");</script>
                            <?php unset($_SESSION['Sp_Delete2']) ?>
                            <?php
                            }
                            ?>
                        </form> 
