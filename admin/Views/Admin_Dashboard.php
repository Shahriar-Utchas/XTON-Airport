...
const testimonials = [
  ...
  window.onload = displayTestimonial;</script>
        ...
        <div class="Form3">
            ...
            ?> $</h1>
                <img id="img1" src="Images/income.png" alt="">
            </div>
                                        <!--  Sub Form-2  -->
            <div id="Form3-2">
            ...
            ?> $</h1>
                <img id="img2" src="Images/Expence.png" alt="">
            </div>
                                        <!--  Sub Form-3  -->
            <div id="Form3-3">
            ...
            ?>
                ...
                <img id="img3" src="Images/Passenger_Served.png" alt="">
            </div>
                                        <!--  Sub Form-4  -->
            <div id="Form3-4">
            ...
            ?></h1>
                <img id="img4" src="Images/flight_operate.png" alt="">
            </div>
        </div>
