...
<div class="lounge"style="background-color:lightyellow">
        ...
        <div class="table-container">
            <table>
                <tr>
                    ...
                    <th>shift</th>
                    <th>Action</th> 
                    <!-- Added a new column for the delete icon -->
                </tr>
                <?php
                require_once '../CONTROLLER/loungecontroller.php'; // Include the controller
...
<div class="acceptcontainer">
    ...
    <h2>ACCEPT PASSENGER</h2>
        <table>
            ...
            <?php
                require_once '../CONTROLLER/loungeacceptcontroller.php'; // Include the controller
...
<div class="rejectcontainer">
    ...
    <h2>REJECT PASSENGER</h2>
        <table>
            ...
            <?php
                require_once '../CONTROLLER/loungerejectcontroller.php'; // Include the controller
